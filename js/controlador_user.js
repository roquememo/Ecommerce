				...
				for (var i = 0; i < count; i++) {
					$("#listView").append('<div class="row">'+	  
						...
						'<h3> L. '+obj[i]['precio']+'</h3>'+			
			  			'<a href="productodetalles.html?id='+obj[i]['id']+'" class="btn btn-large btn-primary"> Agregar a la cesta '+
					...
					$("#ul-blockView").append('<li class="span3">'+
						...
						'<div class="caption">'+
				  		'<h5>'+obj[i]['nombre']+'</h5>'+
				   		...
				   		'<i class="icon-zoom-in"></i></a>'+ 
				   		'<a class="btn" href="#">Agregar a la cesta <i class="icon-shopping-cart"></i>'+
				   		'</a> <a class="btn btn-primary" href="#">'+obj[i]['precio']+'</a></h4>'+
						'</div>'+
			  			'</div>'+
						'</li>');
				}
