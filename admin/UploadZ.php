...
$target_file = $target_dir.basename($_FILES["picFileZ"]["name"]);
$url = "imagenes/productos/".basename($_FILES["picFileZ"]["name"]);
$principal = 1;
move_uploaded_file($_FILES["picFileZ"]["tmp_name"], $target_file);               

           
$nombre = $_POST['nombreZ'];
$precio = $_POST['precioZ'];
$cantidad = $_POST['cantidadZ'];
$descripcion = $_POST['descripcionZ'];
$peso = $_POST['pesoZ'];
$modelo = $_POST['modeloZ'];
$categoria = 6;                 
